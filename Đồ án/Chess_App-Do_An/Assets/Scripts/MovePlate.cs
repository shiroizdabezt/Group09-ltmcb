...
public class MovePlate : MonoBehaviour
{
    ...
    public void OnMouseUp()
    {
        ...
        GameObject.FindGameObjectWithTag("TurnPlayer").GetComponent<Text>().enabled = true;
        GameObject.FindGameObjectWithTag("TurnPlayer").GetComponent<Text>().text = currentPlayer + " turn";
